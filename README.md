...
Development: https://forge.hekkelman.net/maarten/zeep
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libzeep-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libzeep-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `libzeep` available on your platform:
...
```
pixi search libzeep --channel conda-forge
```
